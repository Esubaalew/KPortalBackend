...
from portal.models import Language, CustomUser, Resource

fake = Faker()

# Assuming you want to delete the oldest 600 resources
resources_to_delete = Resource.objects.order_by('date_shared')[:600]
...
#             'name': 'JavaScript',
#             'shorty': 'The scripting standard for webpages.',
#             'description': 'JavaScript is a popular programming language that is primarily used for building '
#                            'interactive web applications.'
#         },
#         {
#             'name': 'Python',
#             'shorty': 'The language of simplicity and power.',
#             'description': 'Python is a versatile and beginner-friendly programming language known for its '
#                            'readability and extensive libraries.'
#         },
#         {
#             'name': 'C++',
#             'shorty': 'The language of systems and games.',
#             'description': 'C++ is a high-performance programming language used to build complex systems and video '
#                            'games.'
#         },
#         {
#             'name': 'Java',
...
#             'name': 'C#',
#             'shorty': 'The language of Microsoft.',
#             'description': 'C# is a versatile programming language developed by Microsoft for building Windows '
#                            'applications.'
#         },
#         {
#             'name': 'PHP',
...
#             'name': 'Swift',
#             'shorty': 'The language of Apple.',
#             'description': 'Swift is a powerful programming language developed by Apple for building iOS and macOS '
#                            'applications.'
#         },
#         {
#             'name': 'Kotlin',
...
#             'name': 'Go',
#             'shorty': 'The language of Google.',
#             'description': 'Go is a statically typed programming language developed by Google for building reliable '
#                            'and efficient software.'
#         },
#         {
#             'name': 'Rust',
#             'shorty': 'The language of performance and safety.',
#             'description': 'Rust is a systems programming language known for its performance, reliability, and memory '
#                            'safety.'
#         },
#         {
#             'name': 'Scala',
#             'shorty': 'The language of scalability.',
#             'description': 'Scala is a powerful programming language known for its scalability and functional '
#                            'programming features.'
#         },
#         {
#             'name': 'Perl',
#             'shorty': 'The language of text processing.',
#             'description': 'Perl is a versatile programming language used for text processing and system '
#                            'administration tasks.'
#         },
#         {
#             'name': 'Lua',
#             'shorty': 'The language of game scripting.',
#             'description': 'Lua is a lightweight programming language used for game scripting and embedded '
#                            'applications.'
#         },
#         {
#             'name': 'Haskell',
#             'shorty': 'The language of pure functional programming.',
#             'description': 'Haskell is a purely functional programming language known for its advanced type system '
#                            'and elegance.'
#         },
#         {
#             'name': 'R',
...
#             'name': 'Dart',
#             'shorty': 'The language of Flutter.',
#             'description': 'Dart is a programming language developed by Google for building mobile, desktop, and web '
#                            'applications.'
#         },
#         {
#             'name': 'Julia',
#             'shorty': 'The language of scientific computing.',
#             'description': 'Julia is a high-level programming language used for scientific computing and numerical '
#                            'analysis.'
#         },
#         {
#             'name': 'Shell',
#             'shorty': 'The language of the command line.',
#             'description': 'Shell scripting is a versatile programming language used for automating system '
#                            'administration tasks.'
#         },
#         {
#             'name': 'PowerShell',
...
#             'name': 'Objective-C',
#             'shorty': 'The language of Apple before Swift.',
#             'description': 'Objective - C is a general - purpose programming language developed by Apple for building '
...
#             'name': 'Visual Basic',
#             'shorty': 'The language of Visual Basic.',
#             'description': 'Visual Basic is an event-driven programming language developed by Microsoft for building '
...
#             'name': 'Fortran',
#             'shorty': 'The language of scientific computing.',
#             'description': 'Fortran is a general-purpose programming language used for scientific and numeric '
#                            'computations.'
#         },
#         {
#             'name': 'Ada',
#             'shorty': 'The language of the Department of Defense.',
#             'description': 'Ada is a structured programming language used in aviation, space, and military '
#                            'applications.'
#         },
#         {
#             'name': 'Lisp',
#             'shorty': 'The language of artificial intelligence.',
#             'description': 'Lisp is a powerful programming language used for artificial intelligence and symbolic '
#                            'computation.'
#         },
#         {
#             'name': 'Prolog',
...
#             'name': 'Smalltalk',
#             'shorty': 'The language of object-oriented programming.',
#             'description': 'Smalltalk is an object-oriented programming language known for its simplicity and '
#                            'flexibility.'
#         },
#         {
#             'name': 'Erlang',
#             'shorty': 'The language of concurrency.',
#             'description': 'Erlang is a functional programming language known for its concurrency and fault-tolerance '
#                            'features.'
#         },
#         {
#             'name': 'Elixir',
#             'shorty': 'The language of the BEAM VM.',
#             'description': 'Elixir is a dynamic, functional programming language designed for building scalable and '
#                            'maintainable applications.'
#         },
#         {
#             'name': 'Clojure',
#             'shorty': 'The language of the JVM.',
#             'description': 'Clojure is a modern dialect of Lisp designed for concurrency and functional programming on '
#                            'the Java Virtual Machine (JVM).'
#         },
#         {
#             'name': 'SQL',
#             'shorty': 'The language of databases.',
#             'description': 'SQL is a standard language for managing and querying databases.'
#         },
#         {
#             'name': 'VHDL',
#             'shorty': 'The language of hardware description.',
#             'description': 'VHDL is a hardware description language used to model and simulate digital circuits.'
#         },
#         {
#             'name': 'Verilog',
#             'shorty': 'The language of hardware design.',
#             'description': 'Verilog is a hardware description language used to design and simulate digital circuits.'
#
#         },
#         {
#             'name': 'MATLAB',
#             'shorty': 'The language of numerical computing.',
#             'description': 'MATLAB is a high-level programming language used for numerical computing and data analysis.'
#         },
#         {
#             'name': 'LabVIEW',
#             'shorty': 'The language of graphical programming.',
#             'description': 'LabVIEW is a graphical programming language used for data acquisition and instrument '
#                            'control.'
#         },
#         {
#             'name': 'Assembly',
#             'shorty': 'The language of low-level programming.',
#             'description': 'Assembly language is a low-level programming language used to write programs that interact '
...
# # Assuming you have already created some languages and users
...
#     topic = fake.word()
#     url = fake.url()
#     date_shared = timezone.now() - timedelta(days=random.randint(1, 365))  # Random date within the last year
#
#     # Create the resource
...
#     )
#
# # Assign language 2 to 39 to resources
# for resource in Resource.objects.all():
#     random_language = random.choice(languages.exclude(id=1))
#     resource.language = random_language
#     resource.save()
#     print('done')
